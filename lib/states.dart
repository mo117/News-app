...
class NewssettingsSuccessLoading extends NewsStates {}

class NewssittingsSuccess extends NewsStates {}

class NewssittingError extends NewsStates {
  final error;

  NewssittingError(this.error);
}
...
class Appmoodchangestste extends NewsStates {}
